...
package com.cncnc.protobuf.chat;
...
public final class Chat {
  ...
  public static final class CPrivateChat extends
    ...
    public static final class Builder extends
      ...
      // Construct using com.cncnc.protobuf.chat.Chat.CPrivateChat.newBuilder()
      private Builder() {
  ...
  public static final class SPrivateChat extends
    ...
    protected FieldAccessorTable
      ...
      return Chat.internal_static_SPrivateChat_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SPrivateChat.class, Builder.class);
    }
    ...
    public static SPrivateChat parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SPrivateChat parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SPrivateChat parseFrom(
    ...
    public static SPrivateChat parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static SPrivateChat parseFrom(
    ...
    public static SPrivateChat parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static SPrivateChat parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SPrivateChat prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using com.cncnc.protobuf.chat.Chat.SPrivateChat.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public SPrivateChat getDefaultInstanceForType() {
        return SPrivateChat.getDefaultInstance();
      }

      public SPrivateChat build() {
        SPrivateChat result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public SPrivateChat buildPartial() {
        SPrivateChat result = new SPrivateChat(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SPrivateChat) {
          return mergeFrom((SPrivateChat)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(SPrivateChat other) {
        if (other == SPrivateChat.getDefaultInstance()) return this;
        if (other.hasContent()) {
          bitField0_ |= 0x00000001;
          content_ = other.content_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SPrivateChat parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SPrivateChat) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  static {
    String[] descriptorData = {
      ...
      "\t\"\037\n\014SPrivateChat\022\017\n\007content\030\001 \002(\tB\037\n\027co" +
      "m.cncnc.protobuf.chatB\004Chat"
    };
