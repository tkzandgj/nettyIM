...
// source: internal_protocol.proto

package com.cncnc.protobuf.protocol;
...
public final class Internal {
  ...
  public enum Dest
    ...
    Client(0, 1),
    /**
     * <code>AuthServer = 2;</code>
     */
    AuthServer(1, 2),
    /**
     * <code>LogicServer = 3;</code>
     */
    LogicServer(2, 3),
    /**
     * <code>GateServer = 4;</code>
     */
    GateServer(3, 4),
    ;
     ...
     * <code>AuthServer = 2;</code>
     */
    public static final int AuthServer_VALUE = 2;
    /**
     * <code>LogicServer = 3;</code>
     */
    public static final int LogicServer_VALUE = 3;
    /**
     * <code>GateServer = 4;</code>
     */
    public static final int GateServer_VALUE = 4;
    ...
    public static Dest valueOf(int value) {
      switch (value) {
        ...
        case 2: return AuthServer;
        case 3: return LogicServer;
        case 4: return GateServer;
        default: return null;
      }
    }
  ...
  public static final class GTransfer extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              Dest value = Dest.valueOf(rawValue);
              if (value == null) {
    ...
    public static GTransfer parseFrom(
    ...
    public static GTransfer parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GTransfer parseFrom(
    ...
    public static GTransfer parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GTransfer parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static GTransfer parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(GTransfer prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.cncnc.protobuf.protocol.Internal.GTransfer.newBuilder()
      private Builder() {
      ...
      public GTransfer getDefaultInstanceForType() {
        return GTransfer.getDefaultInstance();
      }

      public GTransfer build() {
        GTransfer result = buildPartial();
      ...
      public GTransfer buildPartial() {
        GTransfer result = new GTransfer(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GTransfer) {
          return mergeFrom((GTransfer)other);
        } else {
      ...
      public Builder mergeFrom(GTransfer other) {
        if (other == GTransfer.getDefaultInstance()) return this;
        if (other.hasDest()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GTransfer parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GTransfer) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      // required .Dest dest = 1;
      private Dest dest_ = Dest.Client;
      /**
       * <code>required .Dest dest = 1;</code>
       */
      public boolean hasDest() {
       ...
       * <code>required .Dest dest = 1;</code>
       */
      public Builder setDest(Dest value) {
        if (value == null) {
  ...
  public static final class Greet extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              int rawValue = input.readEnum();
              From value = From.valueOf(rawValue);
              if (value == null) {
                unknownFields.mergeVarintField(1, rawValue);
              } else {
                bitField0_ |= 0x00000001;
    ...
    public enum From
       ...
       * <code>LogicServer = 1;</code>
       */
      public static final int LogicServer_VALUE = 1;
      /**
       * <code>GateServer = 2;</code>
       */
       ...
       * <code>AuthServer = 3;</code>
       */
      public static final int AuthServer_VALUE = 3;
      ...
      public static From valueOf(int value) {
        switch (value) {
          case 1: return LogicServer;
          case 2: return GateServer;
          case 3: return AuthServer;
          default: return null;
        }
      }
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return Greet.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public static Greet parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Greet parseFrom(
    ...
    public static Greet parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Greet parseFrom(
    ...
    public static Greet parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Greet parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Greet prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using com.cncnc.protobuf.protocol.Internal.Greet.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Greet getDefaultInstanceForType() {
        return Greet.getDefaultInstance();
      }

      public Greet build() {
        Greet result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Greet buildPartial() {
        Greet result = new Greet(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Greet) {
          return mergeFrom((Greet)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Greet other) {
        if (other == Greet.getDefaultInstance()) return this;
        if (other.hasFrom()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Greet parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Greet) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // required .Greet.From from = 1;
      private From from_ = From.LogicServer;
      /**
       * <code>required .Greet.From from = 1;</code>
       */
      public boolean hasFrom() {
  ...
  static {
    String[] descriptorData = {
      "\n\027internal_protocol.proto\"\\\n\tGTransfer\022\023" +
      "\n\004dest\030\001 \002(\0162\005.Dest\022\r\n\005netId\030\002 \001(\004\022\016\n\006us" +
      "erId\030\003 \002(\t\022\016\n\006ptoNum\030\004 \002(\r\022\013\n\003msg\030\005 \002(\014\"" +
      "[\n\005Greet\022\031\n\004from\030\001 \002(\0162\013.Greet.From\"7\n\004F" +
      "rom\022\017\n\013LogicServer\020\001\022\016\n\nGateServer\020\002\022\016\n\n" +
      "AuthServer\020\003*C\n\004Dest\022\n\n\006Client\020\001\022\016\n\nAuth" +
      "Server\020\002\022\017\n\013LogicServer\020\003\022\016\n\nGateServer\020" +
      "\004B\'\n\033com.cncnc.protobuf.protocolB\010Intern" +
      "al"
    };
