...
public class ParseMap {
    ...
    public static HashMap<Integer, ParseMap.Parsing> parseMap = new HashMap<Integer, ParseMap.Parsing>();
    public static HashMap<Class<?>, Integer> msg2ptoNum = new HashMap<Class<?>, Integer>();
